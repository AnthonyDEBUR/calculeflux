---
title: "flat_importe_qualite_hubeau.Rmd for working package"
...
datafile <- system.file("nyc_squirrels_sample.csv", package = "calculeflux")
...
fusen::inflate(flat_file = "dev/flat_importe_qualite_hubeau.Rmd", vignette_name = "Get started")
```
